...
<div class="container">
    ...
    <strong><h1 style="text-style:bold; text-align: center;font-size:16px;">Paying Total Price : {{$totalprice}} &#2547;</h1></strong>
    <br>
    <hr>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                <div class="panel-heading display-table" >
                    <h1><strong>Paying Total Price : {{$totalprice}} &#2547;</strong> </h1>
